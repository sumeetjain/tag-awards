class VotingPeriod < ActiveRecord::Base
  ...
  validates :ballot_status, inclusion: {in: %w(pending nominations almost-voting voting closed), message: "%{value} is not a valid status of 'pending', 'nominations', 'voting', or 'closed'."}
  ...
  # almost-voting - Between nominations and final votes.
